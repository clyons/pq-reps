...
const MESSAGES: Record<Locale, Messages> = {
  en: {
    ...
    "result.tap_to_play": "Tap to play",
  ...
  es: {
    ...
    "result.tap_to_play": "Toca para reproducir",
  ...
  fr: {
    ...
    "result.tap_to_play": "Touchez pour lancer la lecture",
  ...
  de: {
    ...
    "result.tap_to_play": "Zum Abspielen tippen",
