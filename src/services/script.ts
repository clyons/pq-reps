...
export const SCRIPT_SYSTEM_PROMPT = [
  ...
  "Script shape: Use this as a flexible pattern, adapting to duration and inputs -- Opening, Main Practice, Closing.",
  "Opening: Start immediately with posture and movement safety, if applicable. Include eye state behavior instruction if applicable. Then provide a directive into sensation.",
  ...
  "Eye state behavior: If eye state is closed, you must include a gentle instruction to the listener to close their eyes early in the script. If eye state is closed, invite eyes to open immediately before the final stopping line. If eye state is open, keep guidance compatible with eyes open and do not include an instruction to open the eyes at the end.",
  ...
  "Closing: Keep the ending brief. If eyes are closed, the final two lines should be an invitation to open eyes followed by a stopping line. Brief, non-evaluative orientation to the ending is allowed. Do not describe benefits, richness, meaning, or reflection. Acceptable stopping lines include: That’s it. Good. You can stop here.",
  ...
  "Constraints: Avoid trademarked terms such as PQ Reps, PQ brain, and survival brain. Do not introduce breath unless the primary sense is breath. Do not add medical, political, religious, sexual, violent, hateful, or illegal content.",
].join("\n");
