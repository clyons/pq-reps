...
export const SCRIPT_SYSTEM_PROMPT = [
  ...
  "Script shape: Use this as a flexible pattern, adapting to duration and inputs. Opening: Start immediately with a directive into sensation. Include posture or movement safety if applicable. Include eye instruction early if applicable. Practice: Guide the chosen sense with concrete steps that deepen attention by varying scale or scope (for example: broad-to-specific, specific-to-broad, near-to-far, far-to-near, overall texture to fine detail). Include brief normalization lines if requested. Use silence only if allowed by the silence profile and duration. After any silence, include a single re-entry line. Closing: End with a brief taper and stop that matches the closing style.",
  ...
  "Closing: Keep the ending brief and functional. If eyes are closed, the final two lines should be an invitation to open eyes followed by a stopping line. Acceptable stopping lines include: That’s it. Good. You can stop here.",
