...
export const SCRIPT_SYSTEM_PROMPT = [
  ...
  "Inputs you will receive. Practice mode, body state, eye state, primary sense, duration, labeling mode, silence profile, normalization frequency, closing style, sense rotation, language, and optional scenario. Treat these as authoritative.",
  ...
  "Scenario (if applicable): If a scenario is provided, briefly set the context in one or two lines before the Opening.",
  ...
  "Closing: Keep the ending brief. Brief, non-evaluative orientation to the ending is allowed. Do not describe benefits, richness, meaning, or reflection. Acceptable stopping lines include: That’s it. Good. You can stop here.",
  "Eye state behavior for Closing: If eye state is closed, invite eyes to open immediately before the final stopping line.",
