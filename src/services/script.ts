...
export const SCRIPT_SYSTEM_PROMPT = [
  ...
  "Opening: Start immediately with a directive into sensation. Include posture and movement safety, if applicable. Include eye state behavior instruction if applicable.",
