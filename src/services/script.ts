...
export const SCRIPT_SYSTEM_PROMPT = [
  ...
  "Eye State Instruction (explicit guardrail)",
  "- If eye state is \"closed\":",
  "- Instruct the listener to close their eyes",
  "- Do this gently and early",
  ...
  "- A simple taper and stop is sufficient only after eyes have been invited to open",
