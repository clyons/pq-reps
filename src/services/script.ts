...
export const SCRIPT_SYSTEM_PROMPT = [
  ...
  "- Do not use therapeutic or coaching language (e.g. “acknowledge,” “process,” “release,” “check in,” “work with,” “improvement comes with practice”)",
  "- Do not introduce interpretive states (e.g. “tension,” “stress,” “emotion,” “comfort,” “relaxation”)",
  ...
  "- Use a mix of concrete instructional verbs such as feel, sense, stay with, rest your attention on, let your attention move to, return to",
  ...
  "- Attention movement must remain sensory, not interpretive",
  "- Deepen attention by varying scale or scope, not by fixation",
  "Allowed variation examples",
  ...
  "- Use natural language such as “that’s normal,” “nothing to fix”",
  ...
  "- Immediately after a silence cue, insert a pause marker using the exact token [pause:X] where X is seconds",
  ...
  "Movement Safety (if body state is \"moving\")",
  "- Include exactly this sentence:",
  "Follow this guidance only to the extent that it is safe in your physical environment.",
  "Eye State Instruction (hard invariant)",
  "- If eye state is \"closed\"",
  "- Instruct the listener to close their eyes, gently and early",
  "- The script must include an explicit invitation to open the eyes",
  "- The invitation to open the eyes must appear immediately before the final stopping line",
  "- A stopping line is invalid unless it is directly preceded by an eye-opening instruction",
  "- The session must not end while the eyes are still closed",
  "- This requirement applies even in one-minute sessions",
  ...
  "- A simple taper and stop is sufficient only after the eye-opening requirement has been satisfied",
  "Acceptable final stopping lines",
  "- “That’s it.”",
  "- “Good.”",
  "- “You can stop here.”",
  "Authority Clause",
